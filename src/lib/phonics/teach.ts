 ...
 */
export interface Teach { g: string; mouth: string; action: string; words: string[]; blend: string[] }
...
export const TEACH: Record<string, Teach> = {
  ...
  g:  { g: "g",  mouth: "Back of the tongue up, voice on, quick: g.", action: "Gulp a drink: g, g, g.", words: ["get", "gap", "gum"], blend: ["d", "o", "g"] },
  ...
  ck: { g: "ck", mouth: "Two letters, ONE sound: k. It comes at the end of short words.", action: "Kick again: ck.", words: ["duck", "sock", "kick"], blend: ["s", "o", "ck"] },
  ...
  ff: { g: "ff", mouth: "Two letters, one sound: fff.", action: "Same balloon: fff.", words: ["off", "puff", "huff"], blend: ["o", "ff"] },
  l:  { g: "l",  mouth: "Tongue tip up behind the top teeth, voice on: lll.", action: "Lick a lolly.", words: ["leg", "lid", "lap"], blend: ["l", "e", "g"] },
  ll: { g: "ll", mouth: "Two letters, one sound: lll.", action: "Lick the lolly again.", words: ["bell", "doll", "hill"], blend: ["d", "o", "ll"] },
  ss: { g: "ss", mouth: "Two letters, one sound: sss.", action: "Snake again: sss.", words: ["hiss", "kiss", "mess"], blend: ["m", "e", "ss"] },
};
