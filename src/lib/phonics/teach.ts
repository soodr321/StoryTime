 ...
 */
export interface Teach { g: string; mouth: string; action: string; words: string[]; blend: string[]; position?: "start" | "end"; sameAs?: string }
...
export const TEACH: Record<string, Teach> = {
  ...
  k:  { g: "k",  mouth: "Same sound as c: a quiet click at the back.", action: "Kick a ball.", words: ["kit", "kid", "kick"], blend: ["k", "i", "d"], sameAs: "c" },
  ck: { g: "ck", mouth: "Two letters, ONE sound: k. It comes at the end of short words.", action: "Kick again: ck.", words: ["duck", "sock", "kick"], blend: ["s", "o", "ck"], position: "end", sameAs: "c" },
  ...
  ff: { g: "ff", mouth: "Two letters, one sound: fff.", action: "Same balloon: fff.", words: ["off", "puff", "huff"], blend: ["o", "ff"], position: "end", sameAs: "f" },
  l:  { g: "l",  mouth: "Tongue tip up behind the top teeth, voice on: lll.", action: "Lick a lolly.", words: ["leg", "lid", "lap"], blend: ["l", "e", "g"] },
  ll: { g: "ll", mouth: "Two letters, one sound: lll.", action: "Lick the lolly again.", words: ["bell", "doll", "hill"], blend: ["d", "o", "ll"], position: "end", sameAs: "l" },
  ss: { g: "ss", mouth: "Two letters, one sound: sss.", action: "Snake again: sss.", words: ["hiss", "kiss", "mess"], blend: ["m", "e", "ss"], position: "end", sameAs: "s" },
};
